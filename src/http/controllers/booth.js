...
const getBoothData = exports.getBoothData = async function getBoothData(uw) {
...
const getBooth = exports.getBooth = async function getBooth(req) {
  const uw = req.uwave;
...
const skipBooth = exports.skipBooth = async function skipBooth(req) {
...
const replaceBooth = exports.replaceBooth = async function replaceBooth(req) {
  const uw = req.uwave;
...
const vote = exports.vote = async function vote(uw, userID, direction) {
...
const favorite = exports.favorite = async function favorite(req) {
  const uw = req.uwave;
